...
export const loadInitalData = (setDataLoaded: any) => async(dispatch: any, getState: any) => {
  setDataLoaded(false)
  const data = await (
    await fetch(`https://run.mocky.io/v3/6a02e464-e993-4523-9ced-2445a693ed6f`)
  ).json();
...
export const renameSection = (payload: renameSectionPayload) => async(dispatch: any) => {
  const data = await (
    await fetch(`https://run.mocky.io/v3/6a02e464-e993-4523-9ced-2445a693ed6f`)
  ).json();
  console.log(data)
